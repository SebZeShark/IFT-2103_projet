...
public class Grid : MonoBehaviour
{
    ...
    {
        float ixPos = (node.iGridX*fNodeDiameter - vGridWorldSize.x / 2)+fNodeRadius;
        float iyPos = (node.iGridY*fNodeDiameter - vGridWorldSize.y / 2)+fNodeRadius;
        
        return new Vector3(ixPos, 0.5f, iyPos);
    }
}
